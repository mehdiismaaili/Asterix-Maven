package asterix.chart.line;

import com.formdev.flatlaf.util.UIScale;
import asterix.chart.ChartColor;
import asterix.chart.utils.ChartAnimator;
import asterix.chart.utils.ChartUtils;
import asterix.chart.component.CategoryLabelPopup;
import asterix.chart.data.ChartDataInfo2D;
import asterix.chart.blankchart.PanelChartRender;
import asterix.chart.blankchart.PlotChart;
import asterix.chart.data.category.CategoryDataset;
import asterix.chart.simple.SimpleDataLineChart;
import asterix.chart.spline.Spline;
import asterix.chart.spline.SplinePoint;
...
public class LineChart extends PlotChart {
    ...
    private void init() {
        ...
        color.addColor(new Color(60, 155, 75), new Color(204, 66, 66));
        updateDataset();
    }
    ...
    private void columnChanged(int index) {
        ...
        popup.setDetail(categoryDataset, categoryDataset.getColumnKey(index), valuesFormat, color);
    }
